...
namespace openSourceC.StandardLibrary
{
	...
	public class EventLogEvent
	{
		...
		public EventLogEvent(string message, byte[] data, Guid? userID, MessageLogEntryType messageLogEntryType)
			: this(message, data, (string)null, userID, messageLogEntryType) { }
		...
		/// <param name="eventID">The ID of the event.  Designed for use with the Windows Event Log.</param>
		/// <param name="messageLogEntryType">The event log entry type.</param>
		public EventLogEvent(string message, byte[] data, short? category, int? eventID, MessageLogEntryType messageLogEntryType)
			: this(message, data, (string)null, category, eventID, messageLogEntryType) { }
		...
		public EventLogEvent(string message, byte[] data, Guid? userID, short? category, int? eventID, MessageLogEntryType messageLogEntryType)
			: this(message, data, (string)null, userID, category, eventID, messageLogEntryType) { }
		...
		public EventLogEvent(string message, byte[] data, string source, short? category, int? eventID, MessageLogEntryType messageLogEntryType)
			: this(message, data, source, null, category, eventID, messageLogEntryType) { }
